package com.example.weatherinformation.graph;
    ...
    private void buildBackLine() {
        ...
        if ((this.valueMaxY % this.divideCountY) == 0) {
            ...
            for (int i = 1; i <= this.divideCountY; i++) {
                ...
                // 라벨 (소수점 1자리를 표시하기 위해 기존값에 * 10을 했음)
                String labelY = String.valueOf(((int) (this.valueMaxY / this.divideCountY) * i) / 10.0);
